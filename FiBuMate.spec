...
datas = [('C:\\python\\bin\\tools', 'bin\\tools'), ('C:\\python\\bin\\Imgs', 'bin\\Imgs')]
binaries = []
hiddenimports = ['PIL', 'PIL.Image', 'PIL.ImageTk', 'pandas', 'openpyxl', 'xlrd', 'PyPDF2', 'pypdf', 'fitz', 'docx', 'pptx', 'reportlab', 'matplotlib', 'numpy', 'requests', 'bs4', 'lxml', 'tkcalendar', 'customtkinter', 'cryptography', 'dateutil', 'packaging', 'charset_normalizer']
