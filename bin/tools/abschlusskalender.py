...
_EMBEDDED_SOURCES = {'monthly_close': '## FiBuMate_PATCH_MARKER: 20260609_PROTOCOL_ONLY_SUBTASK_PROGRESS\n'
                  ...
                  'self.open_task_dialog(team), bg=COLORS["blue"], fg="white", bd=0, padx=12, '
                  ...
                  'self.open_task_dialog(task.get("team"), t), bg=COLORS["blue"], fg="white", bd=0, '
                  'padx=6).pack(side="left", padx=2, pady=3)\n'
                  '            tk.Button(action, text="Löschen", command=lambda t=task: self.delete_task(t), '
                  'bg=COLORS["red"], fg="white", bd=0, padx=6).pack(side="left", padx=2, pady=3)\n'
                  '        row_idx += 1\n'
                  '\n'
                  ...
                  '("Zuständig", tk.OptionMenu(form, owner_var, *user_labels.keys())), ("Fristart", '
                  ...
                  '        for r, lab, ent in [(6, day_label, day_entry), (7, workday_label, workday_entry), (8, '
                  ...
                  'bd=0, padx=14, pady=8).pack(side="right", padx=6)\n'
 ...
 'yearly_close': '## FiBuMate_PATCH_MARKER: 20260609_PROTOCOL_ONLY_SUBTASK_PROGRESS\n'
                 ...
                 'bg=COLORS["blue"], fg="white", bd=0, padx=12, pady=5).pack(side="left", padx=8)\n'
                 '            tk.Button(row, text="Aufgaben allen vorhandenen Perioden zuweisen", '
                 'command=self.apply_current_tasks_to_all_periods, bg=COLORS["orange"], fg="white", bd=0, padx=12, '
                 'pady=5).pack(side="left", padx=8)\n'
                 ...
                 '        widgets = [("Aufgabenname", tk.Entry(form, textvariable=title_var, width=52)), '
                 '("Buchungskreis", tk.OptionMenu(form, booking_circle_var, "IDE", "IDG", "IMS", "SPI", "IHB")), '
                 '("Zuständig", tk.OptionMenu(form, owner_var, *user_labels.keys())), ("Fristart", tk.OptionMenu(form, '
...
# ---------------------------------------------------------------------------
APP_VERSION = "0.537-subsubtask-popup-readable"
